...
export const NAV_ITEMS = [
    ...
    { view: ViewType.PROSPEK, label: 'Calon Pengantin 💍', icon: TargetIcon },
    ...
    { view: ViewType.PROJECTS, label: 'Acara Wedding', icon: FolderKanbanIcon },
    ...
    { view: ViewType.GALLERY, label: 'Pricelist Publik Upload', icon: ImageIcon },
...
export const DEFAULT_INCOME_CATEGORIES = ['DP Acara', 'Pelunasan', 'Tambahan (Add-on)', 'Layanan Fisik/Produk', 'Lainnya'];
/** Saran kategori pengeluaran */
export const DEFAULT_EXPENSE_CATEGORIES = ['Gaji Freelancer', 'Operasional', 'Produksi Fisik', 'Transport', 'Perlengkapan', 'Lainnya'];
/** Saran jenis proyek */
export const DEFAULT_PROJECT_TYPES = ['Pernikahan', 'Lamaran / Engagement', 'Corporate / Event', 'Ulang Tahun', 'Wisuda', 'Lainnya'];
/** Saran jenis acara internal (kalender) */
export const DEFAULT_EVENT_TYPES = ['Meeting Pengantin', 'Persiapan Acara', 'Pelaksanaan (Hari H)', 'Evaluasi', 'Lainnya'];
/** Saran kategori paket */
...
export const DEFAULT_PROJECT_STATUS_SUGGESTIONS: {
    ...
    subStatuses: { name: string; note: string }[];
}[] = [
        {
            ...
            description: 'Acara telah dikonfirmasi dan siap dijadwalkan.',
            defaultProgress: 10,
            subStatuses: [
        ...
        },
        {
            ...
            description: 'Pelaksanaan layanan di hari acara pernikahan.',
            defaultProgress: 50,
            subStatuses: [
                { name: 'Loading In / Standby', note: 'Persiapan di lokasi acara' },
                { name: 'Acara Selesai / Pelaksanaan Sukses', note: 'Pekerjaan di hari H selesai' }
            ]
        },
        {
            name: 'Pasca Acara / Penyelesaian',
            color: '#8b5cf6', // purple-500
            description: 'Tahap penyelesaian akhir atau follow-up pasca acara.',
            defaultProgress: 75,
            subStatuses: [
                { name: 'Review / Evaluasi Internal', note: 'Evaluasi hasil kerja hari H' },
                { name: 'Follow-up Pengantin Pasca Acara', note: 'Memastikan kepuasan pengantin' }
            ]
        },
        {
            name: 'Serah Terima Finansial/Aset',
        ...
        },
        {
            ...
            description: 'Mengurus pengarsipan dan penutupan dokumen acara.',
            defaultProgress: 95,
            subStatuses: [
                { name: 'Arsip Data Pengantin', note: 'Menyimpan riwayat acara' },
...
6. Pembatalan: DP tidak dapat dikembalikan jika pembatalkan dilakukan kurang dari 7 hari sebelum acara.`;

export const DEFAULT_PACKAGE_SHARE_TEMPLATE = `Halo {leadName}! 👋

Terima kasih atas ketertarikan Anda. Berikut link katalog paket kami dari {companyName}:

{packageLink}

Silakan pilih paket yang sesuai. Jika ada pertanyaan, jangan ragu untuk menghubungi kami. Terima kasih!`;
...
export const CHAT_TEMPLATES: ChatTemplate[] = [
    {
        ...
        template: 'Halo {clientName}, selamat! Booking Anda untuk acara "{projectName}" telah kami konfirmasi. Kami sangat senang bisa bekerja sama dengan Anda! Tim kami akan segera menghubungi Anda untuk langkah selanjutnya. Terima kasih!'
    },
    {
        id: 'next_steps',
        title: 'Langkah Selanjutnya',
        template: 'Hai {clientName}, menindaklanjuti konfirmasi acara "{projectName}", berikut langkah selanjutnya: [jadwal meeting, survey lokasi, dll]. Mohon informasikan waktu terbaik Anda. Terima kasih.'
    },
    {
        id: 'payment_reminder',
        title: 'Pengingat Pelunasan',
        template: 'Yth. {clientName},\n\nIni pengingat ramah untuk pembayaran pelunasan acara "{projectName}" yang akan segera jatuh tempo.\n\nMohon konfirmasinya jika pembayaran telah dilakukan. Terima kasih.'
    },
    {
        id: 'survey_reminder',
        title: 'Pengingat Survey Lokasi',
        template: 'Hai {clientName}, untuk acara "{projectName}", kami ingin mengatur jadwal survey lokasi. Kapan waktu yang cocok untuk Anda? Terima kasih.'
    },
    {
        id: 'delivery_ready',
        title: 'Hasil Siap Diambil',
