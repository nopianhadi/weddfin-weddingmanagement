...
const PublicGallery: React.FC<PublicGalleryProps> = ({ galleryId }) => {
    ...
    const loadGalleryData = async () => {
        try {
            ...
            setError('Galeri tidak ditemukan atau tidak dapat diakses');
        } finally {
            setIsLoading(false);
        }
    };
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100">
                <div className="text-center p-8 max-w-lg mx-auto">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Galeri Tidak Ditemukan</h3>
            ...
            <main className="max-w-7xl mx-auto px-0 py-0">
                {!gallery.images || gallery.images.length === 0 ? (
                    <div className="text-center py-20">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-3">Galeri Kosong</h3>
                        <p className="text-gray-600 text-lg">Belum ada foto yang diupload ke galeri ini</p>
                    </div>
                ) : (
                    <div>
