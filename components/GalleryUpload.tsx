    ...
    return (
        <div className="space-y-6 lg:space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 bg-brand-surface/60 backdrop-blur-xl p-5 md:p-6 rounded-2xl border border-brand-border/50 shadow-sm">
                <div>
                    <h2 className="text-2xl font-bold text-gradient">Galeri Upload</h2>
                    <p className="text-sm text-brand-text-secondary mt-1">Kelola galeri hasil acara pengantin berdasarkan daerah.</p>
                </div>
                <button
            ...
            {galleries.length === 0 && (
                <div className="text-center py-16 bg-brand-surface/40 backdrop-blur-md rounded-3xl border border-brand-border/50 border-dashed">
                    ...
                    <h3 className="text-xl font-bold text-brand-text-light mb-2">Belum Ada Galeri</h3>
                ...
                <form onSubmit={handleCreateGallery} className="space-y-5 p-1">
                    <div className="input-group">
                        <input
                            ...
                            required
                        />
                        <label htmlFor="newTitle" className="input-label">Judul Galeri</label>
                    </div>
                    ...
                    <div className="input-group">
                        ...
                        <p className="text-[10px] text-brand-text-secondary mt-1 pl-1">Jika diisi, tombol Booking di halaman galeri akan dialihkan ke tautan ini.</p>
                    </div>
                    ...
                    <div className="flex items-center p-3 rounded-xl border border-brand-border/50 bg-brand-bg/50">
                        ...
                        <label htmlFor="is_public" className="ml-3 text-sm font-medium text-brand-text-light cursor-pointer select-none">
                            Buat galeri publik (dapat diakses pengantin)
                        </label>
                    </div>
                ...
                <form onSubmit={handleEditGallery} className="space-y-5 p-1">
                    <div className="input-group">
                        <input
                            ...
                            required
                        />
                        <label htmlFor="editTitle" className="input-label">Judul Galeri</label>
                    </div>
            ...
            <Modal
                ...
                title={`Upload ke ${selectedGallery?.title || 'Galeri'}`}
            >
